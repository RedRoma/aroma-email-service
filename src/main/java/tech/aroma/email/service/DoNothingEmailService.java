 ...
 */
public final class DoNothingEmailService implements EmailService.Iface
{

    private final static Logger LOG = LoggerFactory.getLogger(DoNothingEmailService.class);
    ...
    {
        LOG.info("Received request to send email message: {}", request.emailMessage);
